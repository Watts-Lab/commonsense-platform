...
function Option(props) {
  ...
  return (
    <li>
      <input type="radio" id={props.id_v} name={props.statementClass} value={props.id_v} className="peer opacity-0" checked={props.checked} onChange={e => {}} required={ props.required } />
