  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        ...
        setCommonSenseScore(Number(response.data.commonsensicality.toFixed(4)));
      });
  }, []);
  ...
  return (
    <div className="text-justify leading-relaxed">
      ...
      <p className="font-bold pb-2.5">
        Here's your common sense score: {commonSenseScore}
      </p>
        ...
        <div className="w-full bg-white md:mt-0 sm:max-w-lg xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" action="#">
              ...
              <button
                    type="button"
                    className="w-full justify-center !mt-0.5 text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2"
                  >
                    <svg
                  ...
                  <button
                    type="button"
                    className="w-full justify-center !mt-2 text-white bg-[#1da1f2] hover:bg-[#1da1f2]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 mr-2 mb-2"
                  >
                    <svg
                      class="w-4 h-4 mr-2 -ml-1"
                      aria-hidden="true"
