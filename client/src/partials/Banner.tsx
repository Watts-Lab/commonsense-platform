            ...
            <div className="pb-10 md:pb-16">
              ...
              <div className="max-w-3xl mx-auto px-10">
                ...
                <p className="text-md my-8">
                  Common sense is often defined as “what all sensible people
                  ...
                  common sense, but can't articulate which of their beliefs are
                  commonsensical or how common their beliefs are to others.
                </p>
                <p className="text-md my-8">
                  This project seeks to quantify common sense empirically via a
                  massive online survey experiment. Participants will read a
                  series of "claims" about the physical and social world (e.g.
                  "Dropped pebbles fall to the ground" or "Fully automatic
                  assault rifles should be banned"), state whether they agree
                  with each claim, and also state what they think most other
                  people think.
                </p>
                <p className="text-md my-8">
                  We have developed novel methods to extract statements from
                  several diverse sources including appearances in mass media,
                  non-fiction books, and political campaign emails, as well as
                  statements elicited from human respondents and generated by AI
                  systems. Our findings will shed light on the nature and limits
                  of common sense, thereby aiding research communities (e.g. AI
                  and ML) who wish to explore and simulate this ubiquitous yet
